...
In addition, we also use the same chemistry and cooling network and sink particle method as in \citet{Hummeletal2014}.  Our chemistry network is that described in \citet{Greifetal2009}, and follows the abundance evolution of \h, \hplus, \hminus, \htwo, $\htwo^+$, \he, \heplus, $\he^{++}$, \deut, $\deut^+$, \hd and e$^-$.
