...
The impact this has on the environment in which the minihalo collapses is see in Figure \ref{fig:structure}, where we show the final simulation output on various scales for Halo 1 and Halo 2 both in the absence of any CR background ($\ucr=0$) and with $\ucr=10^5\,u_0$. 
