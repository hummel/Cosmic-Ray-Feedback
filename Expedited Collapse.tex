...
Boosting the $\htwo$ fraction in the gas lowers the density threshold for efficient cooling, allowing the gas to fulfill the Rees-Ostriker \citeyear{1977} criterion sooner by driving the cooling time $t_{\rm \small cool}$ below the freefall time $t_{\rm \small ff}$.
...
Low density filamentary gas is heated and prevented from collapsing, reducing the clumping of the IGM, which may impact the early stages of reionisation.
