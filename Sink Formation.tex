...
This can be primarily attributed to the wide variety of dynamical environments in which the sink particles form.  This is demonstrated in Figure \ref{fig:disks}, where we show the accretion disk structure within the central $20,000\AU$ of each simulation $5000\yr$ after the first sink forms.
