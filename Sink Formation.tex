...
While CRs may indeed work to alter the susceptibility of the disk to fragmentation, any such behaviour is unfortunately obfuscated by variations in the collapse history between simulations.