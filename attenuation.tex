...
($\sim$$100\au$). This same linear behaviour can be seen versus density as well, as shown in Figure 2. In addition we notice that for a given gas density, the column density along the pole is roughly a factor of 10 lower than along the equator.  