...
To account for this difference in optical depth, we assume every line of sight within 45 degrees \citep{Hosokawaetal2011} of the pole experiences column density $N_{\rm \small pole}$ and every other line of sight experiences $N_{\rm \small equator}$. This allows us to calculate an effective optical depth
\begin{equation}
