...
As $\ucr$ increases, the additional heating and ionisation allows the gas to fulfill the Rees-Ostriker criterion ($t_{\rm cool}$ vs. $t_{\rm freefall}$) sooner, expediting collapse to high densities.  
