...
\label{CRchem}
To study the impact of an ionising CR background on primordial star formation, we implement a uniform CR background as discussed in \RefSec{crb}. Accounting for attenuation of the CRB as discussed in \RefSec{attenuation}, the cosmic ray heating rate $\Gamma_{\rm \small CR}$ and ionisation rate $k_{\rm \small CR}$ are given by
\begin{equation}
