...
Integrating the differential CR spectrum over all energies yields the total energy density $u_{\rm \small CR}$ in cosmic rays which, coupled with a redshift-dependent estimate of $\ucr$,
