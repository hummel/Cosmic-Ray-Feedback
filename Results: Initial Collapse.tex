...
As demonstrated by Figure \ref{fig:efrac}, a larger $\ucr$ boosts the resulting ionsation fraction.
This in turn enhances the efficiency of $\htwo$ formation, enhancing cooling and allowing gas in the loitering phase to reach progressively lower temperatures. 
...
By the time we form sink particles at  $10^{12}\cc$ the thermodynamic state of the gas is remarkably similar, even as we vary the CR background strength by five orders of magnitude.
